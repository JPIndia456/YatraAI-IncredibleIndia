...
export type Database = {
  ...
  public: {
        ...
        Relationships: [
          {
            ...
            columns: ["booking_id"]
            isOneToOne: false
            referencedRelation: "yatra_bookings"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Enums: {
      channel_type: "phone_sms" | "whatsapp" | "telegram" | "email"
    }
    CompositeTypes: {
      http_header: {
        field: string | null
