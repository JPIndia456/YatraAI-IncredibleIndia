      ...
      const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: "You are Yatra, an elite Indian travel assistant. Provide accurate, culturally rich travel advice. Use 🇮🇳 emojis and maintain a premium concierge tone.",
            },
            {
              role: "user",
              content: prompt,
