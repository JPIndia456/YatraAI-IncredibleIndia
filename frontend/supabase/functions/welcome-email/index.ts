...
serve(async (req) => {
  ...
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'Yatra <no-reply@yatra-ai.in>',
      to: [email],
      subject: 'Welcome to Yatra!',
      html: `
        <div style="font-family: sans-serif; padding: 20px; background: #050505; color: #fff; border-radius: 12px; border: 1px solid #FF9933;">
          ...
          <p>Welcome to Yatra, your intelligent companion for exploring the soul of India.</p>
          <p>We are excited to help you plan your next cultural odyssey.</p>
          <hr style="border: 1px solid #222; margin: 20px 0;" />
          <p style="font-size: 12px; color: #666;">This is an automated welcome email from Yatra.</p>
        </div>
      `,
    }),
  })
