...
/**
 * Trusted server upsert for Telegram fields when browser RLS blocks INSERT on yatra_profiles.
      ...
      return NextResponse.json(
        {
          ok: false,
          error:
            'Server is missing SUPABASE_SERVICE_ROLE_KEY. Apply the SQL migration for yatra_profiles INSERT + unique(user_id), or add the service role key.',
        },
        { status: 503 },
      );
    }
