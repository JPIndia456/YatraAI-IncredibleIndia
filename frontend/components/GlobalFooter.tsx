    ...
    <footer className="border-t border-orange-100 bg-white py-14 relative z-10">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 text-sm text-slate-500">
        <div className="space-y-4">
          <div className="text-[#000080] font-black text-lg tracking-tight flex items-center gap-2 italic">
        ...
        <div>
          <h4 className="text-[#000080] font-black mb-4 text-xs tracking-[0.2em] uppercase italic">{T('footer_ecosystem', 'Ecosystem')}</h4>
        ...
        <div>
          <h4 className="text-[#000080] font-black mb-4 text-xs tracking-[0.2em] uppercase italic">{T('footer_intelligence', 'Intelligence')}</h4>
          <ul className="space-y-2.5 text-xs font-bold uppercase tracking-tight">
        ...
        <div>
          <h4 className="text-[#000080] font-black mb-4 text-xs tracking-[0.2em] uppercase italic">{T('legal', 'Legal')}</h4>
          <ul className="space-y-2.5 text-xs font-bold uppercase tracking-tight">
