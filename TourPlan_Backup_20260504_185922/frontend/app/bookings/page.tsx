      ...
      try {
        ...
        if (data && data.length > 0) {
          const mapped: Booking[] = data.map((b: any) => ({
            id: b.id,
            ref: b.trip_data?.bookingRef || b.id.slice(0, 8),
            origin: b.trip_data?.from || 'Unknown',
            destination: b.trip_data?.to || 'Unknown',
            tier: b.trip_data?.tier || 'Custom',
            transport: b.trip_data?.transport || 'Transport Service',
            hotel: b.trip_data?.hotel || 'Accommodation',
            total: b.total_amount,
            date: b.trip_data?.date || new Date(b.created_at).toISOString().split('T')[0],
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col items-end gap-2">
                  <div className="text-xl font-black text-emerald-400">₹{booking.total.toLocaleString()}</div>
