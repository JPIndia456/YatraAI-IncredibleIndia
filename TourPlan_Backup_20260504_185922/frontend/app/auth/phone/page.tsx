    ...
    <div className="min-h-screen bg-[#FDFDFB] text-zinc-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black mb-2 tracking-tight text-zinc-900">Mobile Access</h1>
          <p className="text-zinc-500 text-sm font-medium">Fast, secure authorization via 6-digit SMS code</p>
        </div>
