...
const PLATFORM_NAME = 'TourPlan';
const PLATFORM_URL = 'https://tourplan.ai';
const GRIEVANCE_EMAIL = 'support@tourplan.ai';
const GRIEVANCE_PHONE = '+91 1800-TOURPLAN';
  ...
  return (
    <div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 mt-3 space-y-2">
        ...
        <p className="text-xs text-zinc-400">Name: <strong className="text-zinc-200">TourPlan Grievance Cell</strong></p>
    ...
    <div>
      <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-5 mb-6">
        ...
        <p className="text-xs text-zinc-400 leading-relaxed">
          TourPlan is an <strong className="text-zinc-200">AI-powered travel aggregation and planning platform</strong>.
      ...
      <ul className="mt-3 space-y-0.5">
        <Li>TourPlan is an <strong className="text-zinc-200">intermediary</strong> and is not the seller, service provider, or agent for any travel service.</Li>
        <Li>All bookings are transactions directly between you and the respective carrier (railway/airline/hotel).</Li>
        <Li>TourPlan exercises no editorial control over third-party pricing, availability, cancellation policies, or service quality.</Li>
...
function Disclaimer() {
  return (
    <div>
      ...
      <P>Travel prices are volatile and change in real-time. Prices displayed on TourPlan are:</P>
      <ul className="mt-3 space-y-0.5">
      ...
      <P>The AI Brain feature of TourPlan generates responses using large language model technology. The Platform expressly disclaims:</P>
      <ul className="mt-3 space-y-0.5">
    ...
    <div>
      <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-5 mb-6">
        ...
        <p className="text-xs text-zinc-400 leading-relaxed">
          ...
          carrier or service provider (IRCTC, airline, hotel). TourPlan will act as a facilitator
      ...
      <P>Any convenience or platform service fee charged by TourPlan (displayed separately on the checkout screen) is <strong className="text-zinc-200">non-refundable</strong> upon cancellation of a successful booking, except where cancellation is caused by the Platform's own technical failure.</P>
